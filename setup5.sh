...
# Since we're being piped into sh, we need to handle input differently
exec < /dev/tty

echo "This script will install Arch Linux."
echo "Please provide a username and password for your system."
echo "Username must be lowercase, and password must be at least 8 characters."
echo
